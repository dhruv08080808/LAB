import 'package:lab_test_app/app/models/model_latest_report.dart';
import 'package:lab_test_app/app/models/model_nearby_lab.dart';
import 'package:lab_test_app/app/models/model_payment_type.dart';
import 'package:lab_test_app/app/models/model_recent_search.dart';
import 'package:lab_test_app/app/models/model_test_panel.dart';
import 'package:lab_test_app/app/models/model_tests_list.dart';
import 'package:lab_test_app/app/models/model_tips.dart';
import 'package:lab_test_app/app/models/model_top_specialist.dart';
...
class DataFile {
  ...
  static List<ModelTopTips> toptipsList = [
    ModelTopTips(
        'Cardiology',
        'All cardiologists in the branch of medicine study the disorders of the heart, but the study of adult and child heart disorders each require different training pathways.',
        'specialist1.png'),
    ModelTopTips(
        'Dermatology',
  ...
  static List<ModelTopTipsDetails> topTipsDetailsList = [
    ModelTopTipsDetails(
        'Cardiology',
        'All cardiologists in the branch of medicine study the disorders of the heart, but the study of adult and child heart disorders each require different training pathways.',
        'specialist1.png'),
  ...
  static List<TestNameList> testNames = [
    TestNameList('test_panel1.png', 'Blood Test', 100.00),
    TestNameList('test_panel1.png', 'Thyroid Test', 400.00),
    TestNameList('test_panel1.png', 'Urine Test', 160.00),
    TestNameList('test_panel1.png', 'Covid Test', 160.00),
    TestNameList('test_panel1.png', 'Hormone Test', 160.00),
    TestNameList('test_panel1.png', 'Diabetes Test', 160.00),
    TestNameList('test_panel1.png', 'Blood Test', 100.00),
    TestNameList('test_panel1.png', 'Thyroid Test', 400.00),
  ];
  static List<ModelLanguage>listoflanguage=[
    ModelLanguage("Eng_US",),
    ModelLanguage("Eng_UK",),
    ModelLanguage("Hindi"),
