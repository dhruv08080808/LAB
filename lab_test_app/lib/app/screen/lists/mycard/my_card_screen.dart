...
class _MyCardScreenState extends State<MyCardScreen> {
  ...
  Widget buildCardList(BuildContext context) {
    return Column(
      ...
      children: [
        getCustomFont('Your Paynments', 17.sp, Colors.black, 1,
  ...
  Column buildNoCardDataWidget(BuildContext context) {
    return Column(
      ...
      children: [
        getNoDataWidget(context, 'No Orders Yet!',
            'Come on, maybe we still have a \nchance', 'no_card_icon.svg',
            withButton: true, btnText: 'Add New Order', btnClick: () {
  ...
  void handleClick(String value,int index) {
    switch (value) {
      case 'Edit':
        ...
        break;
      case 'Delete':
      if(index>=0 && paymentCardList.length>index){
