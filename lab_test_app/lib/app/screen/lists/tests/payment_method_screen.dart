...
import 'package:lab_test_app/app/models/model_payment_method.dart';
...
class _PaymentMethodScreenState extends State<PaymentMethodScreen> {
  ...
  Widget buildPayNowButton(BuildContext context) {
    return getButton(
      ...
      Colors.white,
      () {
      // selectedPos.value!=5? Constant.sendToNext(context, Routes.aboutLabScreenRoute):
      //   Constant.sendToNext(context, Routes.paymentScreenRoute);

       if (selectedPos.value == 5 || selectedPos.value==4) {
