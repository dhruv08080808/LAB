...
import 'package:lab_test_app/app/controller/controller.dart';
...
class _TestReportScreenState extends State<TestReportScreen> {
  ...
  void handleDownload() async {
    ...
    String fileName = 'sample.pdf'; // Specify the file name you want to save

    try {
      await downloadFile(fileUrl, fileName);
      // File downloaded successfully, show success message or perform any other action
